...
MIDDLEWARE = [
    ...
    "billing.middleware.UsageEnforcementMiddleware",
]
...
# App URLs (for checkout / portal redirects)
...
# Email (production should use SMTP)
...
# Paths where UsageEnforcementMiddleware applies (monthly api_calls limit)
USAGE_ENFORCED_PATH_PREFIXES = ("/api/limited/",)
